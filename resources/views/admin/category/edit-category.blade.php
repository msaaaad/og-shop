                        ...
                        <form action="{{route('/update-category')}}" method="POST">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea name="category_description" id="" cols="30" rows="3" class="form-control">{{$category->category_description}}</textarea>
                            ...
                            <div class="form-group">
                                <div class="col-lg-8 offset-4">
                                    ...
                                    <input type="submit" value="Update Category Info" class="form-control btn btn-info">
                                </div>
                            </div>
