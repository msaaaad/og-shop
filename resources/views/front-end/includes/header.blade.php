        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="header__logo">
                    <a href="{{route('/')}}"><img src="{{asset('/')}}front-end/img/logo.png" alt=""></a>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-3">
                <div class="header__cart">
                    <ul>
                        ...
                        <li><a href="{{route('/show-cart')}}"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
                    </ul>
                    <div class="header__cart__price">item: <a href="{{route('/show-cart')}}">$150.00</a></div>
                </div>
            </div>
        </div>
